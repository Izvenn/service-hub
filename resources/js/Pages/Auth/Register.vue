...
const props = defineProps({
    companies: Array // Recebe as empresas com projetos do Controller
});
...
const filteredProjects = computed(() => {
    const selectedCompany = props.companies.find(c => c.id == form.company_id);
    return selectedCompany ? selectedCompany.projects : [];
});
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4 block">
                <label class="flex items-center">
                    ...
                    <span class="ms-2 text-sm text-gray-600">Registrar como Administrador</span>
                </label>
            ...
            <div class="mt-4">
                ...
                <select id="company_id" v-model="form.company_id" @change="form.project_id = ''"
            ...
            <!-- Projeto (Só habilita se houver empresa) -->
            <div class="mt-4">
                <InputLabel for="project_id" value="Project" />
                <select id="project_id" v-model="form.project_id" :disabled="!form.company_id"
